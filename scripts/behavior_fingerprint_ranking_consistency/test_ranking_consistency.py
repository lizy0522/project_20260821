...
from behavior_fingerprint_ranking_consistency.ranking import (  # noqa: E402
    distance_to_ranks,
    spearman_statistic,
)

RESULT_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2"
