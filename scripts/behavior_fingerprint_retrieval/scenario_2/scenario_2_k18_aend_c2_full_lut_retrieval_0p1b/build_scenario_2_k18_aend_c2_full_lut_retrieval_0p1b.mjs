...
const resultRoot = `${projectRoot}/results/behavior_fingerprint_retrieval/scenario_2/scenario_2_k18_aend_c2_full_lut_retrieval_0p1b`;
const sourcePath = `${resultRoot}/00_xlsx_source.json`;
const outputPath = `${resultRoot}/scenario_2_k18_aend_c2_full_lut_retrieval_0p1b.xlsx`;
const previewPath = "/tmp/scenario_2_k18_aend_c2_full_lut_retrieval_0p1b_state_results_preview.png";
