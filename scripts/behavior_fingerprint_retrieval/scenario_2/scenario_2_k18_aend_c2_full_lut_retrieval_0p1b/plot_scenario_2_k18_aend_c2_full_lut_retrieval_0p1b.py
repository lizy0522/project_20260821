"""Plots for the fixed K18 0.1B Aend/C2 retrieval task."""
...
def write_figures(frame: pd.DataFrame) -> dict[str, object]:
    ...
    figure_01 = RESULT_ROOT / "figure_01_full_metrics_vs_state_0p1b.png"
    ...
    axis.set_title("0.1B Aend-C2 LUT Retrieval: Model Metrics and Real-B CNMSE")
    ...
    figure_02 = RESULT_ROOT / "figure_02_retrieved_real_B_CNMSE_vs_state_0p1b.png"
    ...
    axis.set_title("0.1B Aend-C2 LUT Retrieval: Retrieved Real-B CNMSE")
    axis.grid(alpha=0.22)
