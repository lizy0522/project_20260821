...
from behavior_fingerprint_retrieval.scenario_2.scenario_2_C2_to_Aend_g4_sparse_gmp_5b.plot_scenario2_c2_to_aend_g4_sparse_gmp_5b import (  # noqa: E402
    generate_figures,
)
...
from data_management.shared import build_state_table, load_variable_by_id  # noqa: E402
...
TASK_NAME = "scenario_2_C2_to_Aend_g4_sparse_gmp_5b"
EXPERIMENT_NAME = "scenario_2_C2_to_Aend_G4_sparse_gmp_5B"
RESULT_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" /TASK_NAME / EXPERIMENT_NAME
...
MODEL_LOG = PROJECT_ROOT / "work_logs" / "behavior_fingerprint_retrieval" / "scenario_2" /TASK_NAME / "execution_log.txt"
HANDOFF_LOG = PROJECT_ROOT / "work_logs" / "core" / "codex_handoff" / "codex_handoff.txt"

G4_ROOT = PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_mp_residual_sparse_gmp_5B"
G4_STRUCTURE_PATH = G4_ROOT / "models" / "selected_sparse_gmp_structure.json"
OLD_RETRIEVAL_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" /TASK_NAME / "scenario_2_C2_to_Aend"
OLD_SCENARIO2_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" /"scenario_2" / "scenario_2"
OLD_ALL_ILC_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" /"scenario_2_all_ilc"
...
PROTECTED_RESULT_DIRS = {
    ...
    "unified_capacity_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_unified_odd_order_mp_capacity_scan_5B",
    "odd_only_failed14_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_odd_order_mp_order_dependent_memory_scan_5B",
