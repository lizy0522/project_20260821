...
RESULT_PARENT = PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2"
...
WORK_LOG = PROJECT_ROOT / "work_logs" / "behavior_fingerprint_retrieval" / "scenario_2" /EXPERIMENT_NAME / "execution_log.txt"
...
PROTECTED_PATHS = (
    ...
    STATE_SPECIFIC_ROOT,
    PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" /"scenario_2_C2_to_Aend",
    HISTORICAL_TYPE3_ROOT,
