...
TASK_ROOT = SCRIPTS_ROOT / "behavior_fingerprint_retrieval" / "scenario_2" / "scenario_2_C2_to_Aend_retrieval"  # noqa: E501
RESULT_ROOT = (
    PROJECT_ROOT
    / "results"
...
def _load_raw_scalars() -> pd.DataFrame:
    ...
    from data_management.shared import load_variable_by_id
...
def build_state_summary_frame() -> tuple[pd.DataFrame, dict[str, Any]]:
    ...
    metadata = {
        ...
        "raw_scalar_source": (
            "data_management.load_variable_by_id: nmse_withoutdpd, "
