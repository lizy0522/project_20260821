...
输出：results/pa_performance_observation/scenario_2中的1个CSV和动态N张PNG。
...
from pa_performance_observation import (  # noqa: E402
    collect_scenario2_ilc_acpr,
    plot_acpr_by_iteration,
    plot_all_iterations_together,
)

OUTPUT_DIR = PROJECT_ROOT / "results" / "pa_performance_observation" / "scenario_2"
