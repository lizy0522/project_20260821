...
from behavior_modeling.shared import p5_variable_memory_ridge_scan as model  # noqa: E402
...
from behavior_modeling.scenario_2.scenario_2_failed14_p5_variable_memory_ridge_scan_5b.plot_scenario2_failed14_p5_variable_memory_ridge_scan_5b import (  # noqa: E402
    generate_figures,
)
...
TASK_NAME = "scenario_2_failed14_p5_variable_memory_ridge_scan_5b"
...
def _prepare_cache() -> dict[str, Any]:
    ...
    for position, state_id in enumerate(FAILED_STATE_IDS, start=1):
        ...
        if path.is_file():
            from behavior_modeling.shared.odd_order_variable_memory_scan import load_prepared_state
