...
from behavior_modeling.shared.scenario2_ridge_analysis import (  # noqa: E402
    COARSE_LAMBDAS,
    MODEL_IDS,
...
def test_full_run_artifacts_and_frozen_lambda() -> None:
    result_root = PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_ridge_analysis"  # noqa: E501
...
def test_protected_sources_and_raw_manifest_unchanged() -> None:
    protected = {
        PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"state0_xy_equivalence":
            "b319b05051394bcb7f05c998e4ae22fa338ad130483ecb43af30c4d17d7e4e20",
        PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"state0_ridge_scan":
            "f9ce27eeba0ff2da0b05501826c78e20b53f520991b421e461e6df4b32995aca",
        PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_xy_analysis":
