...
from behavior_modeling.shared import frozen_mp_global_sparse_gmp_residual_support as global_runner  # noqa: E402
...
PREVIOUS_ROOT = PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_frozen_mp_global_sparse_gmp_residual_5B"
...
def main() -> None:
    ...
    protected_dirs = {
        ...
        "all_ilc": PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" /"scenario_2_all_ilc",
    }
