...
SPLIT_PATH = PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_ridge_analysis" / "state_split.csv"
ALL_ILC_METRICS = (
    PROJECT_ROOT
    / "results"
...
PROTECTED_RESULT_DIRS = {
    ...
    "formal_all_ilc": PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" /"scenario_2_all_ilc",
    "unified_capacity": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_unified_odd_order_mp_capacity_scan_5B",
    "odd_only_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_odd_order_mp_order_dependent_memory_scan_5B",
    "p5_ridge_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_P5_variable_memory_ridge_scan_5B",
    "p5_order2_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_P5_with_order2_variable_memory_OLS_scan_5B",
    "neighborhood_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_neighborhood_memory_ridge_scan_5B",
    "prior_sparse_gmp": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_mp_residual_sparse_gmp_5B",
    "g4_retrieval": PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" /"scenario_2_C2_to_Aend_G4_sparse_gmp_5B",
}

PROTECTED_SCRIPT_FILES = (
    PROJECT_ROOT / "scripts" / "behavior_modeling" / "config.py",
    PROJECT_ROOT / "scripts" / "behavior_modeling" / "basis.py",
    PROJECT_ROOT / "scripts" / "behavior_modeling" / "sparse_gmp.py",
    PROJECT_ROOT / "scripts" / "behavior_modeling" / "frozen_neighborhood_memory_ridge_scan.py",
    PROJECT_ROOT / "scripts" / "behavior_modeling" / "scenario2_ridge_analysis.py",
