...
from behavior_modeling.shared import frozen_neighborhood_memory_ridge_scan as frozen_model
from behavior_modeling.shared import sparse_gmp
...
FROZEN_REFERENCE_ROOT = PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_neighborhood_memory_ridge_scan_5B"
...
def main() -> None:
    ...
    with HANDOFF_LOG.open("a", encoding="utf-8") as handle:
        handle.write(f"\n\n{timestamp} | behavior_modeling 新派生任务：Frozen MP basis RMS归一化 + uniform Ridge\n{log}\n")
