...
from behavior_model.statewise_adaptive_model_search import (  # noqa: E402
    C2_STAGE,
...
RETRIEVAL_TASK_NAME = "behavior_fingerprint_lut_retrieval"
MODEL_RESULT_ROOT = (
    PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_statewise_adaptive_Aend_C2_5B"
)
BASELINE_ROOT = PROJECT_ROOT / "results" / RETRIEVAL_TASK_NAME / "scenario_2_C2_to_Aend"
EXISTING_SCAN_ROOT = (
    PROJECT_ROOT
    / "results"
    / RETRIEVAL_TASK_NAME
...
RETRIEVAL_LOG = PROJECT_ROOT / "work_logs" / RETRIEVAL_TASK_NAME / "execution_log.txt"
...
PROTECTED_RESULT_DIRS = {
    ...
    "scenario_2_1B": PROJECT_ROOT / "results" / RETRIEVAL_TASK_NAME / "scenario_2_C2_to_Aend_1B",
...
PROTECTED_SCRIPT_DIRS = {
    ...
    "retrieval": PROJECT_ROOT / "scripts" / RETRIEVAL_TASK_NAME,
}
...
def calculate_nmse(y_ref: np.ndarray, y_pred: np.ndarray) -> float:
    from behavior_model.evaluation import calculate_nmse as _calculate_nmse
