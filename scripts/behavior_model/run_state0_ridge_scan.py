...
输出：results/behavior_model/state_000/ridge_scan下的轻量诊断结果。
...
RESULT_ROOT = PROJECT_ROOT / "results" / "behavior_model" / "state_000" / "ridge_scan"
OLS_ROOT = PROJECT_ROOT / "results" / "behavior_model" / "state_000" / "xy_equivalence"
