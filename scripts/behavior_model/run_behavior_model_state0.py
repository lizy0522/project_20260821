...
from _core.signal import preprocess_pair  # noqa: E402
from data_manager import get_state_info, load_by_id  # noqa: E402

from behavior_model import (  # noqa: E402
    BASIS_TERMS,
    MAX_DELAY,
    MP_CONFIG,
    NUM_COEFFICIENTS,
...
STATE_ID = 0
RESULT_ROOT = PROJECT_ROOT / "results" / "behavior_model" / "state_000"
