...
from behavior_model.plot_scenario2_failed14_frozen_mp_residual_sparse_gmp_5b import (  # noqa: E402
    generate_figures,
)
...
PROTECTED_RESULT_DIRS = {
    ...
    "unified_capacity_scan": PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_unified_odd_order_mp_capacity_scan_5B",
    "odd_only_failed14_scan": PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_failed14_odd_order_mp_order_dependent_memory_scan_5B",
    "p5_ridge_scan": PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_failed14_P5_variable_memory_ridge_scan_5B",
    "p5_order2_scan": PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_failed14_P5_with_order2_variable_memory_OLS_scan_5B",
    "frozen_neighborhood_scan": PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_failed14_frozen_neighborhood_memory_ridge_scan_5B",
}
