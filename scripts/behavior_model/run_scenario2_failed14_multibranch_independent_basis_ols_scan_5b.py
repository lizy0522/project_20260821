...
from behavior_model import multibranch_independent_basis as mb  # noqa: E402
from behavior_model import sparse_gmp as gmp  # noqa: E402
from behavior_model.evaluation import calculate_nmse  # noqa: E402
from behavior_model.plot_scenario2_failed14_multibranch_independent_basis_ols_scan_5b import (  # noqa: E402
    generate_figures,
)
...
FAILURE_SOURCE = PROJECT_ROOT / "results" / "behavior_fingerprint_lut_retrieval" / "scenario_2_C2_to_Aend" / "failed_retrieval_states.csv"
OLD_FORMAL_METRICS = PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2_all_ilc" / "all_ilc_model_metrics.csv"

PROTECTED_RESULT_DIRS = {
    "formal_5B_retrieval": PROJECT_ROOT / "results" / "behavior_fingerprint_lut_retrieval" / "scenario_2_C2_to_Aend",
    "all_ilc_frozen_metrics": PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2_all_ilc",
    "g4_sparse_gmp": PROJECT_ROOT / "results" / TASK_NAME / "scenario_2_C2_to_Aend_G4_sparse_gmp_5B",
    "g4_discovery": PROJECT_ROOT / "results" / TASK_NAME / ".." / "behavior_model" / "scenario_2_failed14_frozen_mp_residual_sparse_gmp_5B",
    "frozen_neighborhood_scan": PROJECT_ROOT / "results" / TASK_NAME / ".." / "behavior_model" / "scenario_2_failed14_frozen_neighborhood_memory_ridge_scan_5B",
    "p5_order2_scan": PROJECT_ROOT / "results" / TASK_NAME / ".." / "behavior_model" / "scenario_2_failed14_P5_with_order2_variable_memory_OLS_scan_5B",
}

G4_DISCOVERY_ROOT = PROJECT_ROOT / "results" / "behavior_model" / "scenario_2_failed14_frozen_mp_residual_sparse_gmp_5B"
G4_STRUCTURE_PATH = G4_DISCOVERY_ROOT / "models" / "selected_sparse_gmp_structure.json"
OLD_FROZEN_RETRIEVAL_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_lut_retrieval" / "scenario_2_C2_to_Aend"
