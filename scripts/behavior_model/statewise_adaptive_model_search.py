...
import numpy as np
import pandas as pd
from behavior_fingerprint_lut_retrieval.scenario2_retrieval_oriented_model_scan import (
...
def prepare_state_pairs(state_id: int) -> PreparedStatePairs:
    """Load one state through data_manager and the canonical preprocessing API."""
