...
RESULT_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_lut_retrieval" / "scenario_2_C2_to_Aend_G4_sparse_gmp_5B"


class G4RetrievalArtifactTests(unittest.TestCase):
    def test_g4_definition_and_shapes(self) -> None:
        structure_path = PROJECT_ROOT / "results" / "behavior_model" / "scenario_2_failed14_frozen_mp_residual_sparse_gmp_5B" / "models" / "selected_sparse_gmp_structure.json"
