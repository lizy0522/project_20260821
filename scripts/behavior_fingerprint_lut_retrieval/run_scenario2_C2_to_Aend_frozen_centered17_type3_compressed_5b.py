...
RESULT_ROOT_PRIMARY = (
    PROJECT_ROOT / "results" / "behavior_fingerprint_lut_retrieval" / EXPERIMENT_NAME
)
...
OLD_TYPE3_SUMMARY = (
    ...
    / "scenario_2_C2_to_Aend_type3_cluster_compressed_5B"
    / "threshold_m40p0dB"
    ...
    for name, command in commands.items():
        ...
        if stale_digest_only:
            ...
            results[name]["note"] = (
                ...
                "scripts/behavior_model digest is stale in the current pre-task workspace."
            )
            continue
