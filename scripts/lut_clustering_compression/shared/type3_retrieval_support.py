...
from lut_clustering_compression.shared.clustering import cluster_behavior_states
from core.shared.signal import adjust_complex_gain, fine_align, rough_align
from behavior_fingerprint_ranking_consistency.shared.distance_matrix import compute_cnmse_distance_matrix
from behavior_fingerprint_ranking_consistency.shared.ranking import distance_to_ranks
from behavior_modeling.shared import sparse_gmp as gmp
...
CLUSTER_ROOT = PROJECT_ROOT / "results" / "lut_clustering_compression" / "scenario_2" / "scenario_2_5b_A_yout_withoutdpd_ori_complete_link"
...
OLD_FORMAL_ROOT = PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" / "scenario_2_C2_to_Aend_retrieval" / "scenario_2_C2_to_Aend"
...
ALL_ILC_METRICS = PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" / "scenario2_all_ilc_analysis" / "scenario_2" / "all_ilc_model_metrics.csv"
ALL_ILC_AVAILABILITY = PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" / "scenario2_all_ilc_analysis" / "scenario_2" / "ilc_availability.csv"
STATE_COUNT = 425
FULL_LENGTH = 24576
ABC_A_START = 0
ABC_A_END = 12288
...
PROTECTED_RESULT_DIRS = {
    "formal_retrieval": OLD_FORMAL_ROOT,
    "formal_g4_retrieval": PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" / "scenario_2_C2_to_Aend_g4_sparse_gmp_5b" / "scenario_2_C2_to_Aend_G4_sparse_gmp_5B",
    "all_ilc": PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" / "scenario2_all_ilc_analysis" / "scenario_2",
    "a123": PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" / "scenario2_y_lut_fusion_a123_analysis" / "scenario_2",
    "clustering": CLUSTER_ROOT,
    "behavior_modeling": PROJECT_ROOT / "results" / "behavior_modeling",
}
