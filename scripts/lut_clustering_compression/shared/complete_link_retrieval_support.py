...
from lut_clustering_compression.shared.clustering import (
...
from signal_segmentation.shared import build_partition_from_xin, get_off_pair, preprocess_full_pair


TASK_NAME = "scenario_2_5b_A_yout_withoutdpd_ori_complete_link"
RESULT_ROOT = PROJECT_ROOT / "results" / "lut_clustering_compression" / "scenario_2" /TASK_NAME
WORK_LOG = (
    PROJECT_ROOT
    / "work_logs"
...
PROTECTED_RESULT_DIRS = {
    "formal_retrieval": PROJECT_ROOT / "results" / "behavior_fingerprint_retrieval" / "scenario_2" /"scenario_2_C2_to_Aend",
    "all_ilc_frozen": PROJECT_ROOT / "results" / "behavior_fingerprint_ranking_consistency" / "scenario_2" /"scenario_2_all_ilc",
    "unified_capacity": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_unified_odd_order_mp_capacity_scan_5B",
    "odd_order_scan": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_odd_order_mp_order_dependent_memory_scan_5B",
    "p5_ridge": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_P5_variable_memory_ridge_scan_5B",
    "p5_order2": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_P5_with_order2_variable_memory_OLS_scan_5B",
    "frozen_neighborhood": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_neighborhood_memory_ridge_scan_5B",
    "sparse_gmp": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_mp_residual_sparse_gmp_5B",
    "multibranch": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_multibranch_independent_basis_OLS_scan_5B",
    "normalized_uniform": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_mp_normalized_uniform_ridge_5B",
    "normalized_dependent": PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2" /"scenario_2_failed14_frozen_mp_normalized_basis_dependent_ridge_5B",
}
...
def _write_cluster_results(matrix: np.ndarray, state_frame: pd.DataFrame, threshold: float, matrix_metadata: dict[str, Any], diagnostics: dict[str, Any], worker_count: int, matrix_action: str, preprocessing_gate: dict[str, Any]) -> tuple[Path, dict[str, Any]]:
    ...
    summary_lines = [
        ...
        "CNMSE definition: existing project core.metrics.cnmse",
