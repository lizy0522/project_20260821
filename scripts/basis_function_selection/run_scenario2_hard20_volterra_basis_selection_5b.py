...
from basis_function_selection.config import (
    CANDIDATE_COUNT,
    DMAX,
...
from basis_function_selection.data_preparation import (
    HardCacheSpec,
    create_hard_cache,
...
from basis_function_selection.hard_state_selection import select_hard_states
from basis_function_selection.model_solver import fit_ridge, ols_scaling_equivalence_gate
from basis_function_selection.ridge_tuning import RidgeTuningResult, tune_ridge
from basis_function_selection.search import (
    PersistentStateEvaluator,
    SearchResult,
    run_sparse_search,
)
from basis_function_selection.selection_metrics import SupportScore
from basis_function_selection.volterra_dictionary import (
    VolterraBasis,
    build_dictionary,
    dictionary_gate,
    support_ids,
...
def _run_engineering_checks() -> dict[str, object]:
    ...
    commands = {
        ...
        "core_regression": [
            str(python),
            "-B",
            str(SCRIPTS_ROOT / "_core" / "test_core_modules.py"),
        ],
