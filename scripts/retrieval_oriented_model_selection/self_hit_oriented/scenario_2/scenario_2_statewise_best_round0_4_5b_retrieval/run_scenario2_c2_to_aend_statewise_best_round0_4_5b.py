...
from behavior_fingerprint_retrieval.shared.scenario2_c2_to_aend_statewise_best_round0_4_5b import (  # noqa: E402  # noqa: E402
    BASELINE_ROOT,
...
RESULT_ROOT = get_route_task_paths("self_hit_oriented", "scenario_2", TASK_NAME).results

MODEL_SOURCE_ROOT = (
    PROJECT_ROOT / "results" / "behavior_modeling" / "scenario_2_statewise_adaptive_Aend_C2_5B"
)
...
PROTECTED_RESULT_DIRS = {
    ...
    / "results" / "retrieval_oriented_model_selection" / "self_hit_oriented" / "scenario_2" /"scenario_2_C2_to_Aend_retrieval_oriented_model_scan",
